    ...
    <div className="rounded-lg mb-4 overflow-hidden text-left" style={{ background: 'var(--bg-elevated)', border: '1px solid var(--lx-border)' }}>
      ...
      {open && (
        <div className="px-4 pb-4 text-xs space-y-2 max-h-64 overflow-y-auto" style={{ color: 'var(--text-muted)' }}>
          ...
          <p>By using Lexio, you agree to use it for personal, non-commercial reading and movie-viewing purposes only and to comply with all terms below.</p>
          <p><strong style={{ color: 'var(--text-primary)' }}>Movies &amp; Third-Party Content</strong><br />Lexio also supports movies. Movie metadata, ratings, artwork, trailers, and reviews are provided by third-party services (including The Movie Database / TMDB and others) and remain the property of their respective owners. Lexio does not host or stream any films. Reviews and discussions you post about movies are subject to the same conduct rules as books.</p>
