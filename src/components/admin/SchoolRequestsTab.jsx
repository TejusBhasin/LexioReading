  ...
  return (
    <div className="space-y-5">
      <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
        Schools requesting content isolation. Approving isolates the school so students only see content from fellow school members.
      </p>
