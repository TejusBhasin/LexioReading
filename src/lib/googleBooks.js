...
export const FALLBACK_TRENDING = [
  ...
  { google_books_id: 'fallback-5', title: 'The Name of the Wind', author: 'Patrick Rothfuss', description: 'A legendary figure tells the true story of his life in this epic fantasy masterpiece.', cover_image: 'https://books.google.com/books/content?id=OsRGPgAACAAJ&printsec=frontcover&img=1&zoom=1', categories: ['Fantasy'], published_date: '2007-03-27', page_count: 662, isbn: '', average_rating: 4.5, ratings_count: 300000, amazon_search_url: 'https://www.amazon.com/s?k=The+Name+of+the+Wind+Rothfuss' },
  ...
  { google_books_id: 'fallback-9', title: 'The Seven Husbands of Evelyn Hugo', author: 'Taylor Jenkins Reid', description: 'A reclusive Hollywood icon finally tells her scandalous story to a young journalist.', cover_image: 'https://books.google.com/books/content?id=dT5MDgAAQBAJ&printsec=frontcover&img=1&zoom=1', categories: ['Fiction', 'Romance'], published_date: '2017-06-13', page_count: 400, isbn: '', average_rating: 4.5, ratings_count: 400000, amazon_search_url: 'https://www.amazon.com/s?k=Seven+Husbands+Evelyn+Hugo' },
